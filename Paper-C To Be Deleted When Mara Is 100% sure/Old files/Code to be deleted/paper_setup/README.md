# Paper setup: Heston Bermudan put
...
- finest asset grid resolution = `2^9 = 512`
- volatility paths = 10000
- low-estimator paths = 10000
...
The Monte Carlo file is parameter-faithful to the paper setup.
The hybrid file is a standalone reimplementation using the paper parameters and the finest reported grid resolution. It is designed so you can compare your run against the published targets, but it is not the authors' exact MLMC-FST code path from the article.
