#!/usr/bin/env python3
"""
Compare the repo-style gDMR LSMC benchmark against the Farahany-style FST hybrid.

The benchmark comes from this folder's benchmark wrapper, which points at the
repo `gdmr_standalone` LSMC logic. The hybrid comes from this folder's FST
wrapper, which points at `gdmr_fst_swap_scripts`.
"""
