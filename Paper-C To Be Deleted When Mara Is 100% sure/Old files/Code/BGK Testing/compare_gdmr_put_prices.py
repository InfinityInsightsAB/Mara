#!/usr/bin/env python3
"""
Compare the BGK-parameter gDMR LSMC benchmark against the Farahany-style FST hybrid.

Both scripts live inside `Code/BGK Testing`, so the test package is self-contained.
"""
