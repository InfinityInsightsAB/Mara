...
SCENARIOS = [
    {"scenario": "ATM", "GDMR_S0": "100.0", "GDMR_STRIKE": "100.0", "GDMR_MATURITY": "2.0"},
    {"scenario": "ITM put", "GDMR_S0": "100.0", "GDMR_STRIKE": "110.0", "GDMR_MATURITY": "2.0"},
    {"scenario": "OTM put", "GDMR_S0": "100.0", "GDMR_STRIKE": "90.0", "GDMR_MATURITY": "2.0"},
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run BGK r=0, T=2 benchmark vs hybrid comparisons.")
    parser.add_argument(
        "--smoke",
        action="store_true",
...
def build_summary(
    ...
    return "\n".join(
        [
            f"# BGK gDMR Comparison with `r=0.0`, `T=2.0` ({run_label})",
            "",
...
def main() -> None:
    ...
    csv_name = "bgk_r00_t2_smoke_table.csv" if args.smoke else "bgk_r00_t2_comparison_table.csv"
    summary_name = "bgk_r00_t2_smoke_summary.md" if args.smoke else "bgk_r00_t2_comparison_summary.md"
