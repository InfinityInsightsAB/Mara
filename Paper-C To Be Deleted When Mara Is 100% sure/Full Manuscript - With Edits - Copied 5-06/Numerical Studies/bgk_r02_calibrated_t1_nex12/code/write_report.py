...
def main() -> None:
    ...
    lines: list[str] = []
    lines.append("# Sandbox Rerun Report: BGK Positive-Rate Numerical Study")
    lines.append("")
    ...
    lines.append("## Scope")
    lines.append("")
    lines.append("- Reference: LSMC, five strikes, `M=1200`, `N=1,200,000`.")
