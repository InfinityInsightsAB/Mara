...
PDF_SCRIPT = CODE_DIR / "write_numerical_pdf.py"
...
def write_metadata(config: dict[str, Any]) -> None:
    metadata = {
        ...
        "engines": {
            ...
            "lsmc_helper": str(LSMC_HELPER),
            "hybrid_helper": str(HYBRID_HELPER),
...
def main() -> None:
    ...
    parser.add_argument("--mode", choices=["smoke", "benchmark", "step", "path", "assets", "validate", "report", "pdf", "full"], default="full")
    ...
    if args.mode in ("pdf", "full"):
        run_script(PDF_SCRIPT)
